...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM users WHERE `nic` = ? AND `password` = ?";
    ...
    if ($result->num_rows > 0) {
        header("Location:User Dashbord.html");
    } else {
    ...
    <div class="container">
        <div class="hero">
            ...
            <section id="hero">
                ...
                <a href="Registation from.php" style="text-decoration: none;">
                    <button>Create Account</button>  
                </a>
                <a href="Stafe Login.php" style="text-decoration: none;">
        ...
        <div class="emergency-container">
            <img src="assets/Images/emergency.png" alt="Emergency Services" class="emergency-info">
            <div class="emergency-text">
                <h3>Emergency Hotline: <span class="hotline">1990</span></h3>
                <p>Colombo Branch Emergency <b>Contact: +94 11 2345678</b></p>
                <p>Kandy Branch Emergency <b>Contact: +94 81 2345678</b></p>
                <p>Galle Branch Emergency <b>Contact: +94 91 2345678</b></p>
            </div>
        </div>
    </div>
