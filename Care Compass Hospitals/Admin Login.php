...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM staff WHERE `position` = ? AND `password` = ?"; 
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ss", $position, $password);
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location:Registation from staff.php");
    } else {
            ...
            <section id="hero">
                <legend>Welcome to Care Compass Hospital</legend>
                    ...
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        ...
                        <input type="text" name="position" size="12">
                    ...
                    <a href="Stafe Login.php">
                        <button>Staff Login</button>
                    </a>
                    <a href="Doctors Login.php">
